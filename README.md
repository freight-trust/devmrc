...
```bash
$ npm install -D devmrc
```

```bash
$ npx devmrc update -d --features vuepress
```
...
```sh-session
$ npm install -g devmrc
$ devmrc COMMAND
running command...
$ devmrc (-v|--version|version)
devmrc/0.1.75 darwin-x64 node-v14.1.0
$ devmrc --help [COMMAND]
USAGE
  $ devmrc COMMAND
...
...
- [`devmrc help [COMMAND]`](#devmrc-help-command)
- [`devmrc uninstall`](#devmrc-uninstall)
- [`devmrc update`](#devmrc-update)

## `devmrc help [COMMAND]`

display help for devmrc
...
_See code: [dist/commands/uninstall.js](https://github.com/ozum/devmrc/blob/v0.1.75/dist/commands/uninstall.js)_
...
EXAMPLES
  $ devmrc update
  $ devmrc update --features vuepress
```

_See code: [dist/commands/update.js](https://github.com/ozum/devmrc/blob/v0.1.75/dist/commands/update.js)_
...
`package.json` entries are merged and added to target project's `package.json`. Also changes made by this project is tracked `devmrcModifications` key in target project's `package.json`.
